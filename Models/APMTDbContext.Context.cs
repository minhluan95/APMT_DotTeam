...
namespace Models
{
    ...
    public partial class CP_SPMEntities1 : DbContext
    {
        ...
        public virtual int sp_deletetask(Nullable<int> process_id)
        {
            var process_idParameter = process_id.HasValue ?
                new ObjectParameter("process_id", process_id) :
                new ObjectParameter("process_id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_deletetask", process_idParameter);
        }
    }
}
